...
import {uploadAttachmentQuery, removeAttachmentQuery} from '../network/queries';
...
class AttachmentsItems extends Component {
  ...
  render() {
    const {file: {fileName, persist}} = this.props;
    ...
    return (
      <View style={attachmentItemsStyle.attachContainer}>
        ...
        <View style={{marginStart: 8}} onLayout={event => this.onlayout(event)}>
          <Bar
  ...
  render() {
    return (
      <View style={generalStyles.container}>
        ...
        />
        <View
          style={[generalStyles.mailContainer, {justifyContent: 'flex-start'}]}>
          <TouchableOpacity
